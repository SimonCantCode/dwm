...
// Path to this folder
//#define DWM_PATH "/home/simon/Documents/Code/dwm"
...
#define FORCE_VSPLIT 1  /* nrowgrid layout: force two clients to always spl    it vertically */
...
// i get an error if i comment this out, too lazy to acctually fix.
...
//	{ MODKEY,                       XK_d,      incnmaster,     {.i = -1 } },
	{ MODKEY,                       XK_d,      spawn,		   SHCMD("/home/simon/Documents/Code/dwm/scripts/define") },
	{ MODKEY,                       XK_h,      setmfact,       {.f = -0.05} },
	{ MODKEY,                       XK_l,      setmfact,       {.f = +0.05} },
	{ MODKEY,                       XK_z,	   zoom,           {0} },
//	{ MODKEY,                       XK_Tab,    view,           {0} },
	{ MODKEY,						XK_c,      killclient,     {0} },
	{ Mod1Mask,						XK_F4,     killclient,     {0} }, // why not
...
//	{ MODKEY|ShiftMask,             XK_period, tagmon,         {.i = +1 } },
	...
	{ MODKEY,						XK_period,					spawn,	SHCMD("xdotool type $(cat /home/simon/Documents/Code/dwm/scripts/emoji | dmenu -i -l 10 | cut -d' ' -f1)") },
